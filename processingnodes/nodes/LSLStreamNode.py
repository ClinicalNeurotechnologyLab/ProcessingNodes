...
from ..DataProcessor import check_data_dimensions, T_Data, T_Timestamps
...
class LSLStreamNode(ProcessingNode):
    def __init__(self, in_channel_labels: List[str],
                 ...
                 feature_dimensions: Optional[list] = None,
                 **settings):
    ...
    def process(
            self, 
            data: T_Data, 
            timestamps: T_Timestamps = None, 
            *args: Any, **kwargs: Any
        ) -> Tuple[T_Data, T_Timestamps]:
