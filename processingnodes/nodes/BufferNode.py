...
from ..DataProcessor import check_data_dimensions, T_Timestamps, T_Data, clear_decorator
...
class BufferNode(ProcessingNode):
    ...
    def init_buffers(self, data):
        ...
        self.buffer = np.zeros(self.buffer_shape, dtype=data.dtype)
    ...
    def process(self, data: T_Data, timestamps: T_Timestamps = None, *args: Any, **kwargs: Any) -> tuple[
    T_Data, T_Timestamps]:
        ...
        return_data = np.zeros(self.return_shape, dtype=self.buffer.dtype)
